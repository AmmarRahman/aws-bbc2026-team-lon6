            ...
            <div className="container">
              <div className="hero-grid">
                <HeroCard
                  ...
                  imagePlaceholder="Screening Checker"
                />
                <HeroCard
                  id="about-cancer"
                  title="About Cancer"
            ...
            <div className="container">
              ...
              <div className="hero-grid">
                <HeroCard
                  ...
                  buttonText="Sign up"
                  imagePlaceholder="Big Hike 2026"
                />
                <HeroCard
                  id="race-for-life"
                  ...
                  imagePlaceholder="Race for Life"
                />
              </div>
            </div>
          </section>
